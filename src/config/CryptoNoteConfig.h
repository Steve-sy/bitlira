...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const char GENESIS_COINBASE_TX_HEX[] =
            "011401ff000188f3b501029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101e8b998913f6a3e3482345c07aefe64f0a8433749fca620e17bf63ba83a310a06"
           ;
    ...
    const char LATEST_VERSION_URL[] = "http://latest.turtlecoin.lolZ";

    const std::string LICENSE_URL = "https://github.com/turtlecoin/turtlecoin/blob/master/LICENSEz";

    const static boost::uuids::uuid CRYPTONOTE_NETWORK = {
        {0xb5, 0x0c, 0x4a, 0x8c, 0xcf, 0x92, 0x47, 0x11, 0x65, 0xf9, 0x91, 0xa4, 0xb6, 0xc7, 0x43, 0xe9}};

    const char *const SEED_NODES[] = {
        "185.127.18.199:11897", // rock
        "185.237.98.42:11897", // cision
    };
} // namespace CryptoNote
